...
set format y "%g"
set grid
set title 'excitermodel, flipped source, G0=2, tau=0.5'

set xlabel 'XBraid iteration'
...
p \
    'braidconvergence.dat' index 0 w l t 'sstop 2' ,\
    'braidconvergence.dat' index 1 w l t 'sstop 4' ,\
    'braidconvergence.dat' index 2 w l t 'sstop 8' ,\
    'braidconvergence.dat' index 3 w l t 'sstop 16' ,\
    'braidconvergence.dat' index 4 w l t 'sstop 32',\
